...
public class RFSLIB extends SubsystemBase {
	...
	public static double ApplyDB_Scld(double Le_x_PwrRqstRaw, double Le_x_DB_Thrsh, double Le_x_DB_Lim) {
	...
	public static double ApplyDB_Zeroed(double Le_x_PwrRqstRaw, double Le_x_DB_Thrsh) {
		double Le_x_PwrRqstLim, Le_x_PwrRqstDBAppl;
		double Le_x_DB_ThrshProt;
	...
	public static double ApplyDB_Clpd(double Le_x_PwrRqstRaw, double Le_x_DB_Thrsh) {
   ...
   /** Method: NormArrayVals - This function will normalize an array to the
	  *  based on the absolute value of the highest value in the array, but
	  *  also limit to the max limit supplied as the second argument of 
	  *  this function.
      * @param: La_x_ValDsrd[]   (double: )
      * @param: Le_x_ValNormMax, (double: )
	  * @return: La_x_ValDsrd[]  (double: ) */	
	public static double[] NormArrayVals(double La_x_ValDsrd[], double Le_x_ValNormMax) {
	...
	public static double LimRateOnInc(double ValRaw, double ValLimPrev, float DeltLimMax) {
        double DeltUpd;
        double ValTemp;
        double ValLimNew;
        boolean LimPosInc;
	...
	public static float AxisPieceWiseLinear_int(float  InpVal,
	                                            int [] AxisArray,
	                                            int    TblSize) {
	    int    InpValInt;
        int    TblSegs;
...
/* 	 (Inp, LwrRef, UprRev) -> ((Inp - LwrRef)/(UprRef - LwrRef)); */
	...
	public static float XY_Lookup_flt(float [] TblArray,
	                                  float    AxisInpIdx,
	                                  int      TblSize)
	  {
	  int    TblSegs;
	 ...
	 * @return: Table Look-Up Output value in engineering units (float) */	
	public static float XYZ_Lookup_flt(float [][] TblArray,
                                       float AxisInpIdxY,
                                       float AxisInpIdxX,
                                       int   TblSizeY,
                                       int   TblSizeX)
