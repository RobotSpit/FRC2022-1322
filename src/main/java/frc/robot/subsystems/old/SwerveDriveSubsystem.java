...
public class SwerveDriveSubsystem extends HolonomicDrivetrainSubsystem {
	...
	private SwerveDriveModule[] SwrvDrvMod = new SwerveDriveModule[] {                            
		new SwerveDriveModule(SwrvMap.FtRt, new WPI_TalonFX(Constants.DRV_MTR_FT_RT), new WPI_TalonFX(Constants.SWRV_MTR_FT_RT), new AnalogInput(Constants.ANA_SWRV_ANG_FT_RT), 0), //real:298 practice: 56
		new SwerveDriveModule(SwrvMap.FtLt, new WPI_TalonFX(Constants.DRV_MTR_FT_LT), new WPI_TalonFX(Constants.SWRV_MTR_FT_LT), new AnalogInput(Constants.ANA_SWRV_ANG_FT_LT), 0), //real:355 practice: 190
		new SwerveDriveModule(SwrvMap.RrLt, new WPI_TalonFX(Constants.DRV_MTR_RR_LT), new WPI_TalonFX(Constants.SWRV_MTR_RR_LT), new AnalogInput(Constants.ANA_SWRV_ANG_RR_LT), 0), //real:293 practice: 59
		new SwerveDriveModule(SwrvMap.RrRt, new WPI_TalonFX(Constants.DRV_MTR_RR_RT), new WPI_TalonFX(Constants.SWRV_MTR_RR_RT), new AnalogInput(Constants.ANA_SWRV_ANG_RR_RT), 0)  //real:390 practice: 212
	};
    ...
    */
    ...
    public void mngSDRV_RZL_PeriodicIntrsvTask() {
		...
		if (VeSDRV_b_RZL_Rqst == true) {
		  ...
		  Le_e_St_RtFt = SwrvDrvMod[SwrvMap.FtRt].learnRotEncdrZeroOfst(Le_b_RZL_InitTrig);
		  Le_e_St_LtFt = SwrvDrvMod[SwrvMap.FtLt].learnRotEncdrZeroOfst(Le_b_RZL_InitTrig);
		  Le_e_St_LtRr = SwrvDrvMod[SwrvMap.RrLt].learnRotEncdrZeroOfst(Le_b_RZL_InitTrig);
		  Le_e_St_RtRr = SwrvDrvMod[SwrvMap.RrRt].learnRotEncdrZeroOfst(Le_b_RZL_InitTrig);			
		  ...
		  SwrvDrvMod[SwrvMap.FtRt].setRotEncdrZeroLearnSt(Te_RZL_St.Inactv);
		  SwrvDrvMod[SwrvMap.FtLt].setRotEncdrZeroLearnSt(Te_RZL_St.Inactv);
	...
	public void HolonomicDrv(double Le_r_PwrLong, double Le_r_PwrLat, double Le_r_PwrRot, boolean Le_b_FieldOriented) {
       ...
       dtrmnDrvMtrDirctn(SwrvMap.FtLt, SwrvMap.RrLt, VeSDRV_b_SwrvRotRqstActv);
       dtrmnDrvMtrDirctn(SwrvMap.FtRt, SwrvMap.RrRt, VeSDRV_b_SwrvRotRqstActv);
       ...
       /* Calculate Rotation Angle Target and Command Target Rotation Positions */
		...
		setDrvMtrSpdByBank(SwrvMap.RtSd, VaSDRV_v_DrvSpdCalcCnvrtd[SwrvMap.FtRt]);
		setDrvMtrSpdByBank(SwrvMap.LtSd, VaSDRV_v_DrvSpdCalcCnvrtd[SwrvMap.FtLt]);
	}
    ...
    private double[] calcRotAngTgtOptmzd(double[] La_Deg_AngTgtRaw) {
		...
		Le_e_RotDirctnLt = dtrmnRotAngRotDirctn(SwrvDrvMod[SwrvMap.FtLt].getDrvMtrDirctn(), SwrvDrvMod[SwrvMap.RrLt].getDrvMtrDirctn(),
			                                    Ls_Deg_AngErr[SwrvMap.FtLt], Ls_Deg_AngErr[SwrvMap.RrLt],
												VaSDRV_Deg_RotAngActRaw[SwrvMap.FtLt], VaSDRV_Deg_RotAngActRaw[SwrvMap.FtLt],
												SwrvDrvMod[SwrvMap.FtLt].getRotModRevs(), SwrvDrvMod[SwrvMap.FtLt].getRotModRevs());
		Le_e_RotDirctnRt = dtrmnRotAngRotDirctn(SwrvDrvMod[SwrvMap.FtRt].getDrvMtrDirctn(), SwrvDrvMod[SwrvMap.RrRt].getDrvMtrDirctn(),
		                                        Ls_Deg_AngErr[SwrvMap.FtRt], Ls_Deg_AngErr[SwrvMap.RrRt],
		                                        VaSDRV_Deg_RotAngActRaw[SwrvMap.FtRt], VaSDRV_Deg_RotAngActRaw[SwrvMap.FtRt],
		                                        SwrvDrvMod[SwrvMap.FtRt].getRotModRevs(), SwrvDrvMod[SwrvMap.FtRt].getRotModRevs());
	...
	public void runSwerveCaddyAtPwr(int Le_i_SwrvBnkIdx, TeMtrDirctn Le_e_MtrDirctn, double Le_r_PwrLvl) {
		...
		if (Le_i_SwrvBnkIdx == SwrvMap.RtSd) {
			SwrvDrvMod[SwrvMap.FtRt].setDrvMtrPwr(Le_r_MtrDirctnSclr * Le_r_PwrLvl);
			SwrvDrvMod[SwrvMap.RrRt].setDrvMtrPwr(Le_r_MtrDirctnSclr * Le_r_PwrLvl);
			SwrvDrvMod[SwrvMap.FtLt].setDrvMtrPwr(0);
			SwrvDrvMod[SwrvMap.RrLt].setDrvMtrPwr(0);
		}
		else {
			SwrvDrvMod[SwrvMap.FtLt].setDrvMtrPwr(Le_r_MtrDirctnSclr * Le_r_PwrLvl);
			SwrvDrvMod[SwrvMap.RrLt].setDrvMtrPwr(Le_r_MtrDirctnSclr * Le_r_PwrLvl);
			SwrvDrvMod[SwrvMap.FtRt].setDrvMtrPwr(0);
			SwrvDrvMod[SwrvMap.RrRt].setDrvMtrPwr(0);
		}
	...
	public void cntrlBrkInSwrvDrv(double Le_r_PwrRot, double Le_r_PwrDrv) {	
		...
		SwrvDrvMod[SwrvMap.FtRt].setDrvMtrPwr(Le_r_PwrDrv);
		SwrvDrvMod[SwrvMap.FtLt].setDrvMtrPwr(Le_r_PwrDrv);
	}
	...
	public int getDrvCaddyEncdrCnts() {
		return((int) Math.round(SwrvDrvMod[SwrvMap.FtRt].getDrvEncdrCntsRel()));
    }
  
	public double getDrvCaddyInchesPerEncdrCnts(int Le_Cnts_DrvEncdrCnts) {
	  double Le_l_DrvWhlDistInches;
	  Le_l_DrvWhlDistInches = SwrvDrvMod[SwrvMap.FtRt].getDrvInchesPerEncdrCnts(Le_Cnts_DrvEncdrCnts); 
	  return(Le_l_DrvWhlDistInches);
	}

	public int getDrvCaddyEncdrCntsPerInches(double Le_l_DrvWhlDistInches) {
	  int Le_Cnts_DrvEncdr;
	  Le_Cnts_DrvEncdr = SwrvDrvMod[SwrvMap.FtRt].getDrvEncdrCntsPerInches(Le_l_DrvWhlDistInches);
	  return(Le_Cnts_DrvEncdr);  
	}
	

	public double getDrvCaddyDistTravelled() {
	  double Le_l_DrvWhlDistInches;
	  Le_l_DrvWhlDistInches =  SwrvDrvMod[SwrvMap.FtRt].getDrvDistTravelled();
	  return(Le_l_DrvWhlDistInches);
	}


	public double calcDrvCaddyDistErr(double Le_l_DrvDistTgtInches) {
		return(Le_l_DrvDistTgtInches - SwrvDrvMod[SwrvMap.FtRt].getDrvDistTravelled());
	}

   // todo Convert to Position Encoder
	...
	public void resetRotEncdrs() {
		for (int i = 0; i < SwrvMap.NumOfCaddies; i++) {
			SwrvDrvMod[i].resetRotEncdrPstn();
		}
	}


	public void resetCaddyRotEncdr(int Le_i_SwrvModIdx) {
		SwrvDrvMod[Le_i_SwrvModIdx].resetRotEncdrPstn();
	}
    ...
    public void setDrvMtrSpdByBank(int Le_i_MtrBnk, double Le_r_DrvPwr) {
		...
		if (Le_i_MtrBnk == SwrvMap.RtSd)
		    Le_e_DrvMtrDirctn = SwrvDrvMod[SwrvMap.FtRt].getDrvMtrDirctn();
	    else
 		    Le_e_DrvMtrDirctn = SwrvDrvMod[SwrvMap.FtLt].getDrvMtrDirctn();

        Le_r_DirctnSclr = (Le_e_DrvMtrDirctn == TeMtrDirctn.Rwd ? -1 : 1); 

		if (Le_i_MtrBnk == SwrvMap.RtSd) {
			SwrvDrvMod[SwrvMap.FtRt].setDrvMtrPwr(Le_r_DirctnSclr * Le_r_DrvPwr);
			SwrvDrvMod[SwrvMap.RrRt].setDrvMtrPwr(Le_r_DirctnSclr * Le_r_DrvPwr);
		}
		else {
			SwrvDrvMod[SwrvMap.FtLt].setDrvMtrPwr(Le_r_DirctnSclr * Le_r_DrvPwr);
			SwrvDrvMod[SwrvMap.RrLt].setDrvMtrPwr(Le_r_DirctnSclr * Le_r_DrvPwr);
		}
    }
    ...
    public void setForwardSetpoint(double setpoint){
	  ...
	  /**
	   * Clear all I accumulation, disable continuous input, and set all 
	   * setpoints to 0 for the Longitudinal Movement Control PID Controller.
	   */
	  public void resetPID_Long() {
		// clear I accumulation
		VsSDRV_PID_Long.reset();
	  ...
	  /**
	   * Clear all I accumulation, disable continuous input, and set all 
	   * setpoints to 0 for the Lateral Movement Control PID Controller.
	   */
	  public void resetPID_Lat() {
		// clear I accumulation
		VsSDRV_PID_Lat.reset();
	  ...
	  /**
	   * Clear all I accumulation, disable continuous input, and set all 
	   * setpoints to 0 for the Rotational Control PID Controller.
	   */
	  public void resetPID_Rot() {
		// clear I accumulation
		VsSDRV_PID_Rot.reset();
