...
public class CA_SwerveRotAbs extends CommandBase {
  ...
  public CA_SwerveRotAbs(SwerveDrivetrain swerveDrivetrain, Camera camera, double tgtRotPstn, boolean stopAtTgt) {
    this.swerveDrivetrain = swerveDrivetrain;
    this.camera = camera;
    this.stopAtTgt = stopAtTgt;
    Xe_Deg_RotAngTgt = tgtRotPstn;
